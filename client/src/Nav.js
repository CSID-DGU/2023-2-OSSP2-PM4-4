        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center h-[60px]">
            ...
            <div className="flex items-center h-[90px] px-[60px]">
              <button
                className="after:absolute after:content-[''] after:w-0 after:b-0 after:l-1/2 after:h-[3px] after:-translate-x-2/4 after:bg-blue-400 after:transition-all .5s ease-out hover:after:w-[100px] cursor-pointer"
                onClick={() => {
          ...
          <div className="flex items-center h-[60px]">
            ...
            <div className="flex items-center ml-[30px]">
              <button
                className="border-[1px] border-[#243c5a] rounded-lg p-[8px] hover:bg-[#000000] hover:text-[#ffffff]"
                onClick={() => {
                  navigate("/login");
                }}
              >
